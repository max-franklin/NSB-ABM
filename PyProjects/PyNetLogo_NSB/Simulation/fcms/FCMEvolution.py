...
class FCMEvolution:
    ...
    @staticmethod
    def mutate(weights: np.ndarray, mutation_rate=0.001):
        """
    ...
    @staticmethod
    def cross_caribou_fcms(parent_a: CaribouFCM, parent_b: CaribouFCM, crossover_rate=0.5) -> CaribouFCM:
        """
        ...
        return CaribouFCM(new_input_to_hidden_weights, new_hidden_to_action_weights)
