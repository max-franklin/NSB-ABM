...
def save_and_plot(df, current_year, ax):
    ...
    sns.lineplot(x='tick', y='max_bio_energy', data=df, label='Max Bio-Energy', color='green', ax=ax)
    sns.lineplot(x='tick', y='min_bio_energy', data=df, label='Min Bio-Energy', color='red', ax=ax)
