...
<experiments>
  ...
  <experiment name="control-run" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <timeLimit steps="1865600"/>
    <enumeratedValueSet variable="centroid-attraction-min">
      <value value="0.04"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="decay-rate">
    ...
    <enumeratedValueSet variable="use-high-res-ndvi?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="show-caribou-utility?">
      <value value="false"/>
    ...
    <enumeratedValueSet variable="scenario">
      <value value="&quot;combined-early-ndvi-w-hunters-hi&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="is-random?">
      <value value="false"/>
    </enumeratedValueSet>
