...
[
  ...
  stop-run
  seed
  magic-centroid  ;; Hack to allow comparison with centroid number

  ;; Network and Grid IDs
  npGridId
  npGridQual
  pGridId
  pGridQual
  ...
  ;; Caribou and FCM Variables
  caribouVarCal  ;; List of caribou-related variables to be calibrated
  ...
  ;; Patch Boundaries for Development
  ...
  ;; Simulation and Time Info
  avg-sim-time  ;; Average simulation time per year
  cent-day-list  ;; List of days for centroid reassignment
  current-season
  year
  day
  hour
...
[
  ...
  ;; Utility and Centroid Utilization
  grid-util-non-para
  grid-util-para
  ...
  ;; Vegetation Ranking
  vegParRank      ; vegetation ranking for pregnant caribou
  vegNonParRank   ; vegetation ranking for non-pregnant caribou

  ;; Miscellaneous
  connected?      ; boolean for stream connectivity
  whitefish?      ; used for broad whitefish harvesting
  coast           ; whether the patch is on the coast
...
to set-debug-util
  ...
  let patch-debug-util-layer gis:load-dataset debug-layer-name
  gis:set-world-envelope (gis:envelope-union-of (gis:envelope-of patch-debug-util-layer))
  gis:apply-raster patch-debug-util-layer patch-debug-util
...
debug-layer-name
debug-layer-name
"data/debug-layers/ASCBand.asc" "data/debug-layers/ASCHill.asc" "data/debug-layers/ASCLinear.asc" "data/debug-layers/ASCPyramid.asc"
0
...
<experiments>
  ...
  <experiment name="caribou_variable_evolution_no-moose" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>year = 1000</exitCondition>
    <enumeratedValueSet variable="energy-gain-factor">
  ...
  <experiment name="2021-CaribouVarEvolution" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>year = 1000</exitCondition>
    <enumeratedValueSet variable="centroid-attraction-min">
    ...
    <enumeratedValueSet variable="enable-kde-write">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="hunter-recomb-prob">
      <value value="0.2"/>
    ...
    <enumeratedValueSet variable="energy-gain-factor">
      <value value="28.299999999999997"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="import-caribou-fcm?">
      <value value="false"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="run-num">
      <value value="14"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
